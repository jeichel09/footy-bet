import { getAllSA } from '../../services/oddsApiService';
...
const SerieAGames = () => {
    ...
    const games = getAllSA();
    return (
        <main className="main-content w-3/5">
            <h2 className='underline font-bold justify-self-center mt-4 text-center'>Italian Serie A Games:</h2>

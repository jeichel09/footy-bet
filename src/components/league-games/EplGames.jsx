import { getAllEpl } from '../../services/oddsApiService';
...
const EplGames = () => {
    ...
    const games = getAllEpl();
    return (
        <main className="main-content w-3/5">
            <h2 className='underline font-bold justify-self-center mt-4 text-center'>English Premier League Games:</h2>
